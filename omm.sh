...
install_openresty_manager() {
    ...
    if [ "$OS_ARCH" = "x86_64" ]; then                
        curl -L https://github.com/jimugou/jimugou.github.io/releases/download/v1.0.0/om.gz -o /tmp/om.tgz
    else
        curl -L https://github.com/jimugou/jimugou.github.io/releases/download/v1.0.0/om_arm64.gz -o /tmp/om.tgz
    fi
...
main() {
    ...
    echo -e "\033[36m访问地址: https://${SERVER_IP}:34567\033[0m"
    echo -e "\033[36m默认账号: admin\033[0m"
    echo -e "\033[36m默认密码: #Passw0rd\033[0m"
    info "=========================================="
