    ...
    while true; do
        ...
        case $sub_choice in
            ...
            12)
                ...
                wget -O /www/server/panel/vhost/nginx/default.conf https://raw.githubusercontent.com/woniu336/open_shell/main/fail2ban/default.conf > /dev/null 2>&1
				
				mkdir -p /www/server/panel/vhost/cert/default
				
                cd /www/server/panel/vhost/cert/default/
                curl -sS -O https://raw.githubusercontent.com/woniu336/open_shell/main/fail2ban/default_server.crt > /dev/null 2>&1
				curl -sS -O https://raw.githubusercontent.com/woniu336/open_shell/main/fail2ban/default_server.key > /dev/null 2>&1
							
                cd /etc/fail2ban/filter.d/
                curl -sS -O https://raw.githubusercontent.com/woniu336/open_shell/main/fail2ban/fail2ban-nginx-cc.conf > /dev/null 2>&1
				curl -sS -O https://raw.githubusercontent.com/woniu336/open_shell/main/fail2ban/nginx-bad-request.conf > /dev/null 2>&1
				
				rm -rf /etc/fail2ban/jail.d/*
				
                cd /etc/fail2ban/jail.d/
                curl -sS -O https://raw.githubusercontent.com/woniu336/open_shell/main/fail2ban/nginx.local > /dev/null 2>&1
				
			    cd /etc/fail2ban/jail.d/
                curl -sS -O https://raw.githubusercontent.com/woniu336/open_shell/main/fail2ban/sshd.local > /dev/null 2>&1

                cd /etc/fail2ban/action.d/
                curl -sS -O https://raw.githubusercontent.com/woniu336/open_shell/main/fail2ban/cloudflare.conf > /dev/null 2>&1
